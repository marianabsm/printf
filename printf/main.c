...
void	test_c(void)
{
	...
	x += printf("  Pf\t:\tThe character %c is visible.\n", 'x');
...
void	test_s(void)
{
	...
	x += printf("  Pf\t:\tThe string \"%s\" is visible.\n", "TRALALA");
...
void	test_d(void)
{
	...
	x += printf("  Pf\t:\tThe number %d is visible.\n", 5671);
...
void	test_i(void)
{
	...
	x += printf("  Pf\t:\tThe number %i is visible.\n", 0);
...
void	test_x(void)
{
	...
	x += printf("  Pf\t:\tThe hex number %x is visible.\n", 5671);
...
void	test_u(void)
{
	...
	x += printf("  Pf\t:\tThe number %u is visible.\n", 5671);
...
void	test_all(void)
{
	...
	x += printf("  Pf\t:\tThe int is %i or %d, the char is %c, the string is \"%s\", the hex is %x or %X, the unsigned is %u and the percent is %%.\n", 42, -42, 's', "Hello", 42, 42, 242);
	y += ft_printf("  Pf\t:\tThe int is %i or %d, the char is %c, the string is \"%s\", the hex is %x or %X, the unsigned is %u and the percent is %%.\n", 42, -42, 's', "Hello", 42, 42, 242);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
}
...
void	test_bonus_char(void)
{
	...
	x = ft_printf("  Ft:\tChar [%08c]\n", 'x');
	y = ft_printf("  Ft:\tChar [%08c]\n", 'x');
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
...
void	test_bonus_str(void)
{
	...
	printf("\n----------- TEST: WIDTH STR -----------\n\n");
	x = printf("  Pf:\tString [%-25s]\n", "Hello!");
	y = ft_printf("  Ft:\tString [%-25s]\n", "Hello!");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	x = printf("  Pf:\tString [%20s]\n", "Hello!");
	y = ft_printf("  Ft:\tString [%20s]\n", "Hello!");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	x = printf("  Pf:\tString [%1s]\n", "Hello World!");
...
void	test_bonus_hex(void)
{
	...
	printf("\n----------- TEST: WIDTH HEX -----------\n\n");
	x = printf("  Pf:\tNumber [%10x]\n", 42);
	y = ft_printf("  Ft:\tNumber [%10x]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%20X]\n", 42);
	y = ft_printf("  Ft:\tNumber [%20X]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%020X]\n", 42);
...
void	test_bonus_unsigned(void)
{
	...
	printf("\n----------- TEST: WIDTH UNSIGNED -----------\n\n");
	x = printf("  Pf:\tNumber [%20u]\n", 42);
	y = ft_printf("  Ft:\tNumber [%20u]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%-15u]\n", 42);
	y = ft_printf("  Ft:\tNumber [%-15u]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%010u]\n", 42);
...
void	test_bonus_int(void)
{
	...
	printf("\n----------- TEST: WIDTH INT -----------\n\n");
	x = printf("  Pf:\tNumber [%20i]\n", 42);
	y = ft_printf("  Ft:\tNumber [%20i]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%08i]\n", 42);
	y = ft_printf("  Ft:\tNumber [%08i]\n", 42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%08i]\n", -42);
	y = ft_printf("  Ft:\tNumber [%08i]\n", -42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%8i]\n", -42);
	y = ft_printf("  Ft:\tNumber [%8i]\n", -42);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	printf("\n----------- TEST: ZERO INT -----------\n\n");
	x = printf("  Pf:\tNumber [%011i]\n", (int)LONG_MAX);
	y = ft_printf("  Ft:\tNumber [%011i]\n", LONG_MAX);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tNumber [%010d]\n", INT_MIN);
...
void	test_bonus_ptr(void)
{
	...
	x = printf("  Pf:\tPointer [%-15p]\n", &x);
	y = ft_printf("  Ft:\tPointer [%-15p]\n", &x);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tPointer [%-20p]\n", &y);
...
void	test_bonus_precision(void)
{
	...
	x = printf("  Pf:\tString, no prec: [%s]\n", "0123456789");
	y = ft_printf("  Ft:\tString, no prec: [%s]\n", "0123456789");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tString, prec 6: [%.6s]\n", "0123456789");
	y = ft_printf("  Ft:\tString, prec 6: [%.6s]\n", "0123456789");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tString, prec 15: [%.15s]\n", "0123456789");
	y = ft_printf("  Ft:\tString, prec 15: [%.15s]\n", "0123456789");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tString, prec 0: [%.0s]\n", "0123456789");
	y = ft_printf("  Ft:\tString, prec 0: [%.0s]\n", "0123456789");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	printf("\n----------- TEST: PRECISION INT -----------\n\n");
	x = printf("  Pf:\tInt, no prec: [%d]\n", 42424242);
	y = ft_printf("  Ft:\tInt, no prec: [%d]\n", 42424242);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tInt, prec 2: [%.2d]\n", 42424242);
	y = ft_printf("  Ft:\tInt, prec 2: [%.2d]\n", 42424242);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = printf("  Pf:\tInt, prec 42: [%.42d]\n", 42424242);
...
void	test_invalid_spec(void)
{
	...
	x = printf("  Pf\t:\tInvalid: [%%w] = [%w]\n");
	y = ft_printf("  Ft\t:\tInvalid: [%%w] = [%w]\n");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	x = printf("  Pf\t:\tInvalid: [%%0] = [%0]\n");
	y = ft_printf("  Ft\t:\tInvalid: [%%0] = [%0]\n");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);

	x = printf("  Pf\t:\tInvalid: [%%14k] = [%14k]\n");
